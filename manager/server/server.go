...
import (
	...
	"github.com/yushk/sport_backend/manager/internal/db"
	"github.com/yushk/sport_backend/manager/server/helper"
...
type Server struct {
	...
	pb.UnimplementedCourseManagerServer
	pb.UnimplementedWorkManagerServer
	pb.UnimplementedWorkSubmitManagerServer
	pb.UnimplementedCommentManagerServer
	pb.UnimplementedSportItemManagerServer
	pb.UnimplementedSportTypeManagerServer
	pb.UnimplementedHomeWorkManagerServer
	pb.UnimplementedSolutionManagerServer
	pb.UnimplementedEvaluateInfoManagerServer
...
func (s *Server) grpcServe() error {
	...
	pb.RegisterCourseManagerServer(s.grpcServer, s)
	pb.RegisterWorkManagerServer(s.grpcServer, s)
	pb.RegisterWorkSubmitManagerServer(s.grpcServer, s)
	pb.RegisterCommentManagerServer(s.grpcServer, s)
	pb.RegisterSportItemManagerServer(s.grpcServer, s)
	pb.RegisterSportTypeManagerServer(s.grpcServer, s)
	pb.RegisterHomeWorkManagerServer(s.grpcServer, s)
	pb.RegisterSolutionManagerServer(s.grpcServer, s)
	pb.RegisterEvaluateInfoManagerServer(s.grpcServer, s)
	// grpc cli
