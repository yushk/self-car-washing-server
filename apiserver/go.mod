module github.com/yushk/sport_backend/apiserver
...
require (
	...
	github.com/yushk/sport_backend/pkg v0.2.3
...
require (
	...
	github.com/ArtisanCloud/PowerWeChat/v3 v3.0.1 // indirect
...
replace github.com/yushk/sport_backend/pkg => ../pkg
