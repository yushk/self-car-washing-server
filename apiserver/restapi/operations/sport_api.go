...
// NewSportAPI creates a new Sport instance
func NewSportAPI(spec *loads.Document) *SportAPI {
	return &SportAPI{
		...
		MonitorCreateCommentHandler: monitor.CreateCommentHandlerFunc(func(params monitor.CreateCommentParams, principal *v1.Principal) middleware.Responder {
			return middleware.NotImplemented("operation monitor.CreateComment has not yet been implemented")
		}),
		MonitorCreateCourseHandler: monitor.CreateCourseHandlerFunc(func(params monitor.CreateCourseParams, principal *v1.Principal) middleware.Responder {
			return middleware.NotImplemented("operation monitor.CreateCourse has not yet been implemented")
		}),
		MonitorCreateEvaluateInfoHandler: monitor.CreateEvaluateInfoHandlerFunc(func(params monitor.CreateEvaluateInfoParams, principal *v1.Principal) middleware.Responder {
			return middleware.NotImplemented("operation monitor.CreateEvaluateInfo has not yet been implemented")
		}),
		MonitorCreateHomeWorkHandler: monitor.CreateHomeWorkHandlerFunc(func(params monitor.CreateHomeWorkParams, principal *v1.Principal) middleware.Responder {
			return middleware.NotImplemented("operation monitor.CreateHomeWork has not yet been implemented")
		}),
		...
		MonitorCreateSolutionHandler: monitor.CreateSolutionHandlerFunc(func(params monitor.CreateSolutionParams, principal *v1.Principal) middleware.Responder {
			return middleware.NotImplemented("operation monitor.CreateSolution has not yet been implemented")
		}),
		MonitorCreateSportItemHandler: monitor.CreateSportItemHandlerFunc(func(params monitor.CreateSportItemParams, principal *v1.Principal) middleware.Responder {
			return middleware.NotImplemented("operation monitor.CreateSportItem has not yet been implemented")
		}),
		MonitorCreateSportTypeHandler: monitor.CreateSportTypeHandlerFunc(func(params monitor.CreateSportTypeParams, principal *v1.Principal) middleware.Responder {
			return middleware.NotImplemented("operation monitor.CreateSportType has not yet been implemented")
		}),
		...
		MonitorDeleteCommentHandler: monitor.DeleteCommentHandlerFunc(func(params monitor.DeleteCommentParams, principal *v1.Principal) middleware.Responder {
			return middleware.NotImplemented("operation monitor.DeleteComment has not yet been implemented")
		}),
		MonitorDeleteCourseHandler: monitor.DeleteCourseHandlerFunc(func(params monitor.DeleteCourseParams, principal *v1.Principal) middleware.Responder {
			return middleware.NotImplemented("operation monitor.DeleteCourse has not yet been implemented")
		}),
		MonitorDeleteEvaluateInfoHandler: monitor.DeleteEvaluateInfoHandlerFunc(func(params monitor.DeleteEvaluateInfoParams, principal *v1.Principal) middleware.Responder {
			return middleware.NotImplemented("operation monitor.DeleteEvaluateInfo has not yet been implemented")
		}),
		MonitorDeleteHomeWorkHandler: monitor.DeleteHomeWorkHandlerFunc(func(params monitor.DeleteHomeWorkParams, principal *v1.Principal) middleware.Responder {
			return middleware.NotImplemented("operation monitor.DeleteHomeWork has not yet been implemented")
		}),
		...
		MonitorDeleteSolutionHandler: monitor.DeleteSolutionHandlerFunc(func(params monitor.DeleteSolutionParams, principal *v1.Principal) middleware.Responder {
			return middleware.NotImplemented("operation monitor.DeleteSolution has not yet been implemented")
		}),
		MonitorDeleteSportItemHandler: monitor.DeleteSportItemHandlerFunc(func(params monitor.DeleteSportItemParams, principal *v1.Principal) middleware.Responder {
			return middleware.NotImplemented("operation monitor.DeleteSportItem has not yet been implemented")
		}),
		MonitorDeleteSportTypeHandler: monitor.DeleteSportTypeHandlerFunc(func(params monitor.DeleteSportTypeParams, principal *v1.Principal) middleware.Responder {
			return middleware.NotImplemented("operation monitor.DeleteSportType has not yet been implemented")
		}),
		...
		MonitorGetCommentHandler: monitor.GetCommentHandlerFunc(func(params monitor.GetCommentParams, principal *v1.Principal) middleware.Responder {
			return middleware.NotImplemented("operation monitor.GetComment has not yet been implemented")
		}),
		MonitorGetCommentsHandler: monitor.GetCommentsHandlerFunc(func(params monitor.GetCommentsParams, principal *v1.Principal) middleware.Responder {
			return middleware.NotImplemented("operation monitor.GetComments has not yet been implemented")
		}),
		MonitorGetCourseHandler: monitor.GetCourseHandlerFunc(func(params monitor.GetCourseParams, principal *v1.Principal) middleware.Responder {
			return middleware.NotImplemented("operation monitor.GetCourse has not yet been implemented")
		}),
		MonitorGetCoursesHandler: monitor.GetCoursesHandlerFunc(func(params monitor.GetCoursesParams, principal *v1.Principal) middleware.Responder {
			return middleware.NotImplemented("operation monitor.GetCourses has not yet been implemented")
		}),
		MonitorGetEvaluateInfosHandler: monitor.GetEvaluateInfosHandlerFunc(func(params monitor.GetEvaluateInfosParams, principal *v1.Principal) middleware.Responder {
			return middleware.NotImplemented("operation monitor.GetEvaluateInfos has not yet been implemented")
		}),
		MonitorGetHomeWorkHandler: monitor.GetHomeWorkHandlerFunc(func(params monitor.GetHomeWorkParams, principal *v1.Principal) middleware.Responder {
			return middleware.NotImplemented("operation monitor.GetHomeWork has not yet been implemented")
		}),
		MonitorGetHomeWorksHandler: monitor.GetHomeWorksHandlerFunc(func(params monitor.GetHomeWorksParams, principal *v1.Principal) middleware.Responder {
			return middleware.NotImplemented("operation monitor.GetHomeWorks has not yet been implemented")
		}),
		...
		UserGetPhoneNumberHandler: user.GetPhoneNumberHandlerFunc(func(params user.GetPhoneNumberParams, principal *v1.Principal) middleware.Responder {
			return middleware.NotImplemented("operation user.GetPhoneNumber has not yet been implemented")
		}),
		UserGetSTSTokenHandler: user.GetSTSTokenHandlerFunc(func(params user.GetSTSTokenParams) middleware.Responder {
			return middleware.NotImplemented("operation user.GetSTSToken has not yet been implemented")
		}),
		MonitorGetSolutionHandler: monitor.GetSolutionHandlerFunc(func(params monitor.GetSolutionParams, principal *v1.Principal) middleware.Responder {
			return middleware.NotImplemented("operation monitor.GetSolution has not yet been implemented")
		}),
		MonitorGetSolutionsHandler: monitor.GetSolutionsHandlerFunc(func(params monitor.GetSolutionsParams, principal *v1.Principal) middleware.Responder {
			return middleware.NotImplemented("operation monitor.GetSolutions has not yet been implemented")
		}),
		MonitorGetSportItemHandler: monitor.GetSportItemHandlerFunc(func(params monitor.GetSportItemParams, principal *v1.Principal) middleware.Responder {
			return middleware.NotImplemented("operation monitor.GetSportItem has not yet been implemented")
		}),
		MonitorGetSportItemsHandler: monitor.GetSportItemsHandlerFunc(func(params monitor.GetSportItemsParams, principal *v1.Principal) middleware.Responder {
			return middleware.NotImplemented("operation monitor.GetSportItems has not yet been implemented")
		}),
		MonitorGetSportTypeHandler: monitor.GetSportTypeHandlerFunc(func(params monitor.GetSportTypeParams, principal *v1.Principal) middleware.Responder {
			return middleware.NotImplemented("operation monitor.GetSportType has not yet been implemented")
		}),
		MonitorGetSportTypesHandler: monitor.GetSportTypesHandlerFunc(func(params monitor.GetSportTypesParams, principal *v1.Principal) middleware.Responder {
			return middleware.NotImplemented("operation monitor.GetSportTypes has not yet been implemented")
		}),
		...
		UserGetUserInfoHandler: user.GetUserInfoHandlerFunc(func(params user.GetUserInfoParams) middleware.Responder {
		...
		MonitorUpdateCommentHandler: monitor.UpdateCommentHandlerFunc(func(params monitor.UpdateCommentParams, principal *v1.Principal) middleware.Responder {
			return middleware.NotImplemented("operation monitor.UpdateComment has not yet been implemented")
		}),
		MonitorUpdateCourseHandler: monitor.UpdateCourseHandlerFunc(func(params monitor.UpdateCourseParams, principal *v1.Principal) middleware.Responder {
			return middleware.NotImplemented("operation monitor.UpdateCourse has not yet been implemented")
		}),
		MonitorUpdateEvaluateInfoHandler: monitor.UpdateEvaluateInfoHandlerFunc(func(params monitor.UpdateEvaluateInfoParams, principal *v1.Principal) middleware.Responder {
			return middleware.NotImplemented("operation monitor.UpdateEvaluateInfo has not yet been implemented")
		}),
		MonitorUpdateHomeWorkHandler: monitor.UpdateHomeWorkHandlerFunc(func(params monitor.UpdateHomeWorkParams, principal *v1.Principal) middleware.Responder {
			return middleware.NotImplemented("operation monitor.UpdateHomeWork has not yet been implemented")
		}),
		...
		MonitorUpdateSolutionHandler: monitor.UpdateSolutionHandlerFunc(func(params monitor.UpdateSolutionParams, principal *v1.Principal) middleware.Responder {
			return middleware.NotImplemented("operation monitor.UpdateSolution has not yet been implemented")
		}),
		MonitorUpdateSportItemHandler: monitor.UpdateSportItemHandlerFunc(func(params monitor.UpdateSportItemParams, principal *v1.Principal) middleware.Responder {
			return middleware.NotImplemented("operation monitor.UpdateSportItem has not yet been implemented")
		}),
		MonitorUpdateSportTypeHandler: monitor.UpdateSportTypeHandlerFunc(func(params monitor.UpdateSportTypeParams, principal *v1.Principal) middleware.Responder {
			return middleware.NotImplemented("operation monitor.UpdateSportType has not yet been implemented")
		}),
		...
		UserWXLoginHandler: user.WXLoginHandlerFunc(func(params user.WXLoginParams) middleware.Responder {
			return middleware.NotImplemented("operation user.WXLogin has not yet been implemented")
		}),
...
type SportAPI struct {
	...
	// MonitorCreateCommentHandler sets the operation handler for the create comment operation
	MonitorCreateCommentHandler monitor.CreateCommentHandler
	// MonitorCreateCourseHandler sets the operation handler for the create course operation
	MonitorCreateCourseHandler monitor.CreateCourseHandler
	// MonitorCreateEvaluateInfoHandler sets the operation handler for the create evaluate info operation
	MonitorCreateEvaluateInfoHandler monitor.CreateEvaluateInfoHandler
	// MonitorCreateHomeWorkHandler sets the operation handler for the create home work operation
	MonitorCreateHomeWorkHandler monitor.CreateHomeWorkHandler
	...
	// MonitorCreateSolutionHandler sets the operation handler for the create solution operation
	MonitorCreateSolutionHandler monitor.CreateSolutionHandler
	// MonitorCreateSportItemHandler sets the operation handler for the create sport item operation
	MonitorCreateSportItemHandler monitor.CreateSportItemHandler
	// MonitorCreateSportTypeHandler sets the operation handler for the create sport type operation
	MonitorCreateSportTypeHandler monitor.CreateSportTypeHandler
	...
	// MonitorDeleteCommentHandler sets the operation handler for the delete comment operation
	MonitorDeleteCommentHandler monitor.DeleteCommentHandler
	// MonitorDeleteCourseHandler sets the operation handler for the delete course operation
	MonitorDeleteCourseHandler monitor.DeleteCourseHandler
	// MonitorDeleteEvaluateInfoHandler sets the operation handler for the delete evaluate info operation
	MonitorDeleteEvaluateInfoHandler monitor.DeleteEvaluateInfoHandler
	// MonitorDeleteHomeWorkHandler sets the operation handler for the delete home work operation
	MonitorDeleteHomeWorkHandler monitor.DeleteHomeWorkHandler
	...
	// MonitorDeleteSolutionHandler sets the operation handler for the delete solution operation
	MonitorDeleteSolutionHandler monitor.DeleteSolutionHandler
	// MonitorDeleteSportItemHandler sets the operation handler for the delete sport item operation
	MonitorDeleteSportItemHandler monitor.DeleteSportItemHandler
	// MonitorDeleteSportTypeHandler sets the operation handler for the delete sport type operation
	MonitorDeleteSportTypeHandler monitor.DeleteSportTypeHandler
	...
	// MonitorGetCommentHandler sets the operation handler for the get comment operation
	MonitorGetCommentHandler monitor.GetCommentHandler
	// MonitorGetCommentsHandler sets the operation handler for the get comments operation
	MonitorGetCommentsHandler monitor.GetCommentsHandler
	// MonitorGetCourseHandler sets the operation handler for the get course operation
	MonitorGetCourseHandler monitor.GetCourseHandler
	// MonitorGetCoursesHandler sets the operation handler for the get courses operation
	MonitorGetCoursesHandler monitor.GetCoursesHandler
	// MonitorGetEvaluateInfosHandler sets the operation handler for the get evaluate infos operation
	MonitorGetEvaluateInfosHandler monitor.GetEvaluateInfosHandler
	// MonitorGetHomeWorkHandler sets the operation handler for the get home work operation
	MonitorGetHomeWorkHandler monitor.GetHomeWorkHandler
	// MonitorGetHomeWorksHandler sets the operation handler for the get home works operation
	MonitorGetHomeWorksHandler monitor.GetHomeWorksHandler
	...
	// UserGetPhoneNumberHandler sets the operation handler for the get phone number operation
	UserGetPhoneNumberHandler user.GetPhoneNumberHandler
	// UserGetSTSTokenHandler sets the operation handler for the get s t s token operation
	UserGetSTSTokenHandler user.GetSTSTokenHandler
	// MonitorGetSolutionHandler sets the operation handler for the get solution operation
	MonitorGetSolutionHandler monitor.GetSolutionHandler
	// MonitorGetSolutionsHandler sets the operation handler for the get solutions operation
	MonitorGetSolutionsHandler monitor.GetSolutionsHandler
	// MonitorGetSportItemHandler sets the operation handler for the get sport item operation
	MonitorGetSportItemHandler monitor.GetSportItemHandler
	// MonitorGetSportItemsHandler sets the operation handler for the get sport items operation
	MonitorGetSportItemsHandler monitor.GetSportItemsHandler
	// MonitorGetSportTypeHandler sets the operation handler for the get sport type operation
	MonitorGetSportTypeHandler monitor.GetSportTypeHandler
	// MonitorGetSportTypesHandler sets the operation handler for the get sport types operation
	MonitorGetSportTypesHandler monitor.GetSportTypesHandler
	...
	// MonitorUpdateCommentHandler sets the operation handler for the update comment operation
	MonitorUpdateCommentHandler monitor.UpdateCommentHandler
	// MonitorUpdateCourseHandler sets the operation handler for the update course operation
	MonitorUpdateCourseHandler monitor.UpdateCourseHandler
	// MonitorUpdateEvaluateInfoHandler sets the operation handler for the update evaluate info operation
	MonitorUpdateEvaluateInfoHandler monitor.UpdateEvaluateInfoHandler
	// MonitorUpdateHomeWorkHandler sets the operation handler for the update home work operation
	MonitorUpdateHomeWorkHandler monitor.UpdateHomeWorkHandler
	...
	// MonitorUpdateSolutionHandler sets the operation handler for the update solution operation
	MonitorUpdateSolutionHandler monitor.UpdateSolutionHandler
	// MonitorUpdateSportItemHandler sets the operation handler for the update sport item operation
	MonitorUpdateSportItemHandler monitor.UpdateSportItemHandler
	// MonitorUpdateSportTypeHandler sets the operation handler for the update sport type operation
	MonitorUpdateSportTypeHandler monitor.UpdateSportTypeHandler
	...
	// UserWXLoginHandler sets the operation handler for the w x login operation
	UserWXLoginHandler user.WXLoginHandler
...
func (o *SportAPI) UseRedoc() {
	o.useSwaggerUI = false
}

// UseSwaggerUI for documentation at /docs
func (o *SportAPI) UseSwaggerUI() {
	o.useSwaggerUI = true
}

// SetDefaultProduces sets the default produces media type
func (o *SportAPI) SetDefaultProduces(mediaType string) {
	o.defaultProduces = mediaType
}

// SetDefaultConsumes returns the default consumes media type
func (o *SportAPI) SetDefaultConsumes(mediaType string) {
	o.defaultConsumes = mediaType
}

// SetSpec sets a spec that will be served for the clients.
func (o *SportAPI) SetSpec(spec *loads.Document) {
	o.spec = spec
}

// DefaultProduces returns the default produces media type
func (o *SportAPI) DefaultProduces() string {
	return o.defaultProduces
}

// DefaultConsumes returns the default consumes media type
func (o *SportAPI) DefaultConsumes() string {
	return o.defaultConsumes
}

// Formats returns the registered string formats
func (o *SportAPI) Formats() strfmt.Registry {
	return o.formats
}

// RegisterFormat registers a custom format validator
func (o *SportAPI) RegisterFormat(name string, format strfmt.Format, validator strfmt.Validator) {
	o.formats.Add(name, format, validator)
}

// Validate validates the registrations in the SportAPI
func (o *SportAPI) Validate() error {
	...
	if o.MonitorCreateCommentHandler == nil {
		unregistered = append(unregistered, "monitor.CreateCommentHandler")
	}
	if o.MonitorCreateCourseHandler == nil {
		unregistered = append(unregistered, "monitor.CreateCourseHandler")
	}
	if o.MonitorCreateEvaluateInfoHandler == nil {
		unregistered = append(unregistered, "monitor.CreateEvaluateInfoHandler")
	}
	if o.MonitorCreateHomeWorkHandler == nil {
		unregistered = append(unregistered, "monitor.CreateHomeWorkHandler")
	}
	...
	if o.MonitorCreateSolutionHandler == nil {
		unregistered = append(unregistered, "monitor.CreateSolutionHandler")
	}
	if o.MonitorCreateSportItemHandler == nil {
		unregistered = append(unregistered, "monitor.CreateSportItemHandler")
	}
	if o.MonitorCreateSportTypeHandler == nil {
		unregistered = append(unregistered, "monitor.CreateSportTypeHandler")
	}
	...
	if o.MonitorDeleteCommentHandler == nil {
		unregistered = append(unregistered, "monitor.DeleteCommentHandler")
	}
	if o.MonitorDeleteCourseHandler == nil {
		unregistered = append(unregistered, "monitor.DeleteCourseHandler")
	}
	if o.MonitorDeleteEvaluateInfoHandler == nil {
		unregistered = append(unregistered, "monitor.DeleteEvaluateInfoHandler")
	}
	if o.MonitorDeleteHomeWorkHandler == nil {
		unregistered = append(unregistered, "monitor.DeleteHomeWorkHandler")
	}
	...
	if o.MonitorDeleteSolutionHandler == nil {
		unregistered = append(unregistered, "monitor.DeleteSolutionHandler")
	}
	if o.MonitorDeleteSportItemHandler == nil {
		unregistered = append(unregistered, "monitor.DeleteSportItemHandler")
	}
	if o.MonitorDeleteSportTypeHandler == nil {
		unregistered = append(unregistered, "monitor.DeleteSportTypeHandler")
	}
	...
	if o.MonitorGetCommentHandler == nil {
		unregistered = append(unregistered, "monitor.GetCommentHandler")
	}
	if o.MonitorGetCommentsHandler == nil {
		unregistered = append(unregistered, "monitor.GetCommentsHandler")
	}
	if o.MonitorGetCourseHandler == nil {
		unregistered = append(unregistered, "monitor.GetCourseHandler")
	}
	if o.MonitorGetCoursesHandler == nil {
		unregistered = append(unregistered, "monitor.GetCoursesHandler")
	}
	if o.MonitorGetEvaluateInfosHandler == nil {
		unregistered = append(unregistered, "monitor.GetEvaluateInfosHandler")
	}
	if o.MonitorGetHomeWorkHandler == nil {
		unregistered = append(unregistered, "monitor.GetHomeWorkHandler")
	}
	if o.MonitorGetHomeWorksHandler == nil {
		unregistered = append(unregistered, "monitor.GetHomeWorksHandler")
	}
	...
	if o.UserGetPhoneNumberHandler == nil {
		unregistered = append(unregistered, "user.GetPhoneNumberHandler")
	}
	if o.UserGetSTSTokenHandler == nil {
		unregistered = append(unregistered, "user.GetSTSTokenHandler")
	}
	if o.MonitorGetSolutionHandler == nil {
		unregistered = append(unregistered, "monitor.GetSolutionHandler")
	}
	if o.MonitorGetSolutionsHandler == nil {
		unregistered = append(unregistered, "monitor.GetSolutionsHandler")
	}
	if o.MonitorGetSportItemHandler == nil {
		unregistered = append(unregistered, "monitor.GetSportItemHandler")
	}
	if o.MonitorGetSportItemsHandler == nil {
		unregistered = append(unregistered, "monitor.GetSportItemsHandler")
	}
	if o.MonitorGetSportTypeHandler == nil {
		unregistered = append(unregistered, "monitor.GetSportTypeHandler")
	}
	if o.MonitorGetSportTypesHandler == nil {
		unregistered = append(unregistered, "monitor.GetSportTypesHandler")
	}
	...
	if o.MonitorUpdateCommentHandler == nil {
		unregistered = append(unregistered, "monitor.UpdateCommentHandler")
	}
	if o.MonitorUpdateCourseHandler == nil {
		unregistered = append(unregistered, "monitor.UpdateCourseHandler")
	}
	if o.MonitorUpdateEvaluateInfoHandler == nil {
		unregistered = append(unregistered, "monitor.UpdateEvaluateInfoHandler")
	}
	if o.MonitorUpdateHomeWorkHandler == nil {
		unregistered = append(unregistered, "monitor.UpdateHomeWorkHandler")
	}
	...
	if o.MonitorUpdateSolutionHandler == nil {
		unregistered = append(unregistered, "monitor.UpdateSolutionHandler")
	}
	if o.MonitorUpdateSportItemHandler == nil {
		unregistered = append(unregistered, "monitor.UpdateSportItemHandler")
	}
	if o.MonitorUpdateSportTypeHandler == nil {
		unregistered = append(unregistered, "monitor.UpdateSportTypeHandler")
	}
	...
	if o.UserWXLoginHandler == nil {
		unregistered = append(unregistered, "user.WXLoginHandler")
	}
...
func (o *SportAPI) ServeErrorFor(operationID string) func(http.ResponseWriter, *http.Request, error) {
	return o.ServeError
}

// AuthenticatorsFor gets the authenticators for the specified security schemes
func (o *SportAPI) AuthenticatorsFor(schemes map[string]spec.SecurityScheme) map[string]runtime.Authenticator {
...
func (o *SportAPI) Authorizer() runtime.Authorizer {
	return o.APIAuthorizer
}

// ConsumersFor gets the consumers for the specified media types.
// MIME type parameters are ignored here.
func (o *SportAPI) ConsumersFor(mediaTypes []string) map[string]runtime.Consumer {
...
// MIME type parameters are ignored here.
func (o *SportAPI) ProducersFor(mediaTypes []string) map[string]runtime.Producer {
...
func (o *SportAPI) HandlerFor(method, path string) (http.Handler, bool) {
	if o.handlers == nil {
		return nil, false
	}
...
// Context returns the middleware context for the sport API
func (o *SportAPI) Context() *middleware.Context {
	if o.context == nil {
...
func (o *SportAPI) initHandlerCache() {
	...
	o.handlers["POST"]["/v1/comment"] = monitor.NewCreateComment(o.context, o.MonitorCreateCommentHandler)
	if o.handlers["POST"] == nil {
		o.handlers["POST"] = make(map[string]http.Handler)
	}
	o.handlers["POST"]["/v1/course"] = monitor.NewCreateCourse(o.context, o.MonitorCreateCourseHandler)
	if o.handlers["POST"] == nil {
		o.handlers["POST"] = make(map[string]http.Handler)
	}
	o.handlers["POST"]["/v1/evaluateInfo"] = monitor.NewCreateEvaluateInfo(o.context, o.MonitorCreateEvaluateInfoHandler)
	if o.handlers["POST"] == nil {
		o.handlers["POST"] = make(map[string]http.Handler)
	}
	o.handlers["POST"]["/v1/homeWork"] = monitor.NewCreateHomeWork(o.context, o.MonitorCreateHomeWorkHandler)
	if o.handlers["POST"] == nil {
		o.handlers["POST"] = make(map[string]http.Handler)
	}
	...
	o.handlers["POST"]["/v1/solution"] = monitor.NewCreateSolution(o.context, o.MonitorCreateSolutionHandler)
	if o.handlers["POST"] == nil {
		o.handlers["POST"] = make(map[string]http.Handler)
	}
	o.handlers["POST"]["/v1/sportItem"] = monitor.NewCreateSportItem(o.context, o.MonitorCreateSportItemHandler)
	if o.handlers["POST"] == nil {
		o.handlers["POST"] = make(map[string]http.Handler)
	}
	o.handlers["POST"]["/v1/sportType"] = monitor.NewCreateSportType(o.context, o.MonitorCreateSportTypeHandler)
	if o.handlers["POST"] == nil {
		o.handlers["POST"] = make(map[string]http.Handler)
	}
	...
	o.handlers["DELETE"]["/v1/comment/{id}"] = monitor.NewDeleteComment(o.context, o.MonitorDeleteCommentHandler)
	if o.handlers["DELETE"] == nil {
		o.handlers["DELETE"] = make(map[string]http.Handler)
	}
	o.handlers["DELETE"]["/v1/course/{id}"] = monitor.NewDeleteCourse(o.context, o.MonitorDeleteCourseHandler)
	if o.handlers["DELETE"] == nil {
		o.handlers["DELETE"] = make(map[string]http.Handler)
	}
	o.handlers["DELETE"]["/v1/evaluateInfo/{id}"] = monitor.NewDeleteEvaluateInfo(o.context, o.MonitorDeleteEvaluateInfoHandler)
	if o.handlers["DELETE"] == nil {
		o.handlers["DELETE"] = make(map[string]http.Handler)
	}
	o.handlers["DELETE"]["/v1/homeWork/{id}"] = monitor.NewDeleteHomeWork(o.context, o.MonitorDeleteHomeWorkHandler)
	if o.handlers["DELETE"] == nil {
		o.handlers["DELETE"] = make(map[string]http.Handler)
	}
	...
	o.handlers["DELETE"]["/v1/solution/{id}"] = monitor.NewDeleteSolution(o.context, o.MonitorDeleteSolutionHandler)
	if o.handlers["DELETE"] == nil {
		o.handlers["DELETE"] = make(map[string]http.Handler)
	}
	o.handlers["DELETE"]["/v1/sportItem/{id}"] = monitor.NewDeleteSportItem(o.context, o.MonitorDeleteSportItemHandler)
	if o.handlers["DELETE"] == nil {
		o.handlers["DELETE"] = make(map[string]http.Handler)
	}
	o.handlers["DELETE"]["/v1/sportType/{id}"] = monitor.NewDeleteSportType(o.context, o.MonitorDeleteSportTypeHandler)
	if o.handlers["DELETE"] == nil {
		o.handlers["DELETE"] = make(map[string]http.Handler)
	}
	...
	o.handlers["GET"]["/v1/comment/{id}"] = monitor.NewGetComment(o.context, o.MonitorGetCommentHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/v1/Comments"] = monitor.NewGetComments(o.context, o.MonitorGetCommentsHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/v1/course/{id}"] = monitor.NewGetCourse(o.context, o.MonitorGetCourseHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/v1/courses"] = monitor.NewGetCourses(o.context, o.MonitorGetCoursesHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/v1/evaluateInfos"] = monitor.NewGetEvaluateInfos(o.context, o.MonitorGetEvaluateInfosHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/v1/homeWork/{id}"] = monitor.NewGetHomeWork(o.context, o.MonitorGetHomeWorkHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/v1/homeWorks"] = monitor.NewGetHomeWorks(o.context, o.MonitorGetHomeWorksHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	...
	o.handlers["GET"]["/v1/wx/phone"] = user.NewGetPhoneNumber(o.context, o.UserGetPhoneNumberHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/v1/osssts"] = user.NewGetSTSToken(o.context, o.UserGetSTSTokenHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/v1/solution/{id}"] = monitor.NewGetSolution(o.context, o.MonitorGetSolutionHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/v1/solutions"] = monitor.NewGetSolutions(o.context, o.MonitorGetSolutionsHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/v1/sportItem/{id}"] = monitor.NewGetSportItem(o.context, o.MonitorGetSportItemHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/v1/sportItems"] = monitor.NewGetSportItems(o.context, o.MonitorGetSportItemsHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/v1/sportType/{id}"] = monitor.NewGetSportType(o.context, o.MonitorGetSportTypeHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/v1/sportTypes"] = monitor.NewGetSportTypes(o.context, o.MonitorGetSportTypesHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	...
	o.handlers["PUT"]["/v1/comment/{id}"] = monitor.NewUpdateComment(o.context, o.MonitorUpdateCommentHandler)
	if o.handlers["PUT"] == nil {
		o.handlers["PUT"] = make(map[string]http.Handler)
	}
	o.handlers["PUT"]["/v1/course/{id}"] = monitor.NewUpdateCourse(o.context, o.MonitorUpdateCourseHandler)
	if o.handlers["PUT"] == nil {
		o.handlers["PUT"] = make(map[string]http.Handler)
	}
	o.handlers["PUT"]["/v1/evaluateInfo/{id}"] = monitor.NewUpdateEvaluateInfo(o.context, o.MonitorUpdateEvaluateInfoHandler)
	if o.handlers["PUT"] == nil {
		o.handlers["PUT"] = make(map[string]http.Handler)
	}
	o.handlers["PUT"]["/v1/homeWork/{id}"] = monitor.NewUpdateHomeWork(o.context, o.MonitorUpdateHomeWorkHandler)
	if o.handlers["PUT"] == nil {
		o.handlers["PUT"] = make(map[string]http.Handler)
	}
	...
	o.handlers["PUT"]["/v1/solution/{id}"] = monitor.NewUpdateSolution(o.context, o.MonitorUpdateSolutionHandler)
	if o.handlers["PUT"] == nil {
		o.handlers["PUT"] = make(map[string]http.Handler)
	}
	o.handlers["PUT"]["/v1/sportItem/{id}"] = monitor.NewUpdateSportItem(o.context, o.MonitorUpdateSportItemHandler)
	if o.handlers["PUT"] == nil {
		o.handlers["PUT"] = make(map[string]http.Handler)
	}
	o.handlers["PUT"]["/v1/sportType/{id}"] = monitor.NewUpdateSportType(o.context, o.MonitorUpdateSportTypeHandler)
	if o.handlers["PUT"] == nil {
		o.handlers["PUT"] = make(map[string]http.Handler)
	}
	...
	o.handlers["GET"]["/v1/wx/login"] = user.NewWXLogin(o.context, o.UserWXLoginHandler)
}

// Serve creates a http handler to serve the API over HTTP
// can be used directly in http.ListenAndServe(":8000", api.Serve(nil))
func (o *SportAPI) Serve(builder middleware.Builder) http.Handler {
	o.Init()
...
func (o *SportAPI) RegisterConsumer(mediaType string, consumer runtime.Consumer) {
	o.customConsumers[mediaType] = consumer
}

// RegisterProducer allows you to add (or override) a producer for a media type.
func (o *SportAPI) RegisterProducer(mediaType string, producer runtime.Producer) {
	o.customProducers[mediaType] = producer
}

// AddMiddlewareFor adds a http middleware to existing handler
func (o *SportAPI) AddMiddlewareFor(method, path string, builder middleware.Builder) {
	um := strings.ToUpper(method)
	if path == "/" {
		path = ""
	}
