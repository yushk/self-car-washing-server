...
const (
	...
	AccessKeyID = "LTAI5tA9rMM1DG7aYjjNcFd1"
	AccessKey   = "eirQDpiBPDzLRd4x28Gz5z62dzfwZU"
...
func init() {
	viperInitOnce.Do(func() {
		...
		config.SetDefault(PodNamespace, "sport")
		...
		config.SetDefault(DBUsername, "root")
		config.SetDefault(DBPassword, "kaisawind")
